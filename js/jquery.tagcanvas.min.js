...
(function (f) {
  ...
  for (r = 0; r < 256; ++r)
    (F = r.toString(16)),
      r < 16 && (F = "0" + F),
      (D[F] = D[F.toUpperCase()] = r.toString() + ",");
  function o(a) {
  ...
  (B = t.prototype),
    ...
    (B.unit = function () {
      var a = this.length();
      return new t(this.x / a, this.y / a, this.z / a);
    });
  function aH(b, a) {
  ...
  function ad(n, o, l, k, h, g) {
    ...
    for (a = 0; a < n; ++a)
      (d = a * i - 1 + i / 2),
        ...
        (c = m(b)),
        (e = s(b)),
        f.push(o ? [d * l, c * k, e * h] : [c * l, d * k, e * h]);
    return f;
  }
  ...
  function aF(a, b, c, d, e) {
    return ad(a, 0, b, c, d, e);
  }
  function aE(a, b, c, d, e) {
    return ad(a, 1, b, c, d, e);
  }
  function aC(b, c, d, e, a) {
    return (a = isNaN(a) ? 0 : a * 1), aa(0, b, c, d, e, a);
  }
  function ap(b, c, d, e, a) {
  ...
  function H(a, m, j) {
    ...
    if (a.gCanvas) (f = a.gCanvas.getContext("2d")), (d = a.gCanvas.height);
      ...
      if ((C(e[0]) ? (d = e.length) : (e = [e]), (a.gCanvas = g = l(k, d)), !g))
        return null;
      f = g.getContext("2d");
  ...
  (J = R.prototype),
    (J.SetImage = function (a, b, c, d, e, f, g, h) {
      (this.image = a),
    ...
    (J.Create = function (G, D, F, b, A, m, q, j, E) {
      var o,
        e,
        f,
        a,
      ...
      return (
        ...
        !o
          ...
          : ((k = g = b / 2),
            ...
            (x = i(E, s / 2, u / 2)),
            (a = o.getContext("2d")),
            D && ((a.fillStyle = D), z(a, k, g, s, u, x)),
            b &&
              ((a.strokeStyle = F), (a.lineWidth = b), z(a, k, g, s, u, x, !0)),
            (m || B || C) &&
              ((t = l(e, f)), t && ((y = a), (a = t.getContext("2d")))),
            Z(
              a,
              this.font,
              G,
  ...
  function ac(n, u, t, e, s, c, v, d, r, w) {
    ...
    return k
      ? ((c *= e),
        ...
        (b = k.getContext("2d")),
        (p = i(r, m / 2, j / 2)),
        s && ((b.fillStyle = s), z(b, h, q, m, j, p)),
        c && ((b.strokeStyle = v), (b.lineWidth = c), z(b, h, q, m, j, p, !0)),
        w
          ? ((o = l(g, f)),
            (a = o.getContext("2d")),
        ...
        : (f.indexOf("%") > 0 ? (b = (g * b) / 100) : (b = b * j),
          ...
          b >= g / 2
            ? ((b = i(c, d) / 2),
              ...
              a.fill(),
              a.closePath())
            : ((b = i(c / 2, d / 2, b)), z(a, 0, 0, c, d, b, !0), a.fill()),
          (a.globalCompositeOperation = "source-in"),
  ...
  function af(m, o, k) {
    ...
    (g = j.getContext("2d")),
      (g.fillStyle = "#000"),
      g.fillRect(0, 0, c, h),
      Z(g, k + "px " + o, "#fff", m, 0, 0, 0, 0, [], "centre"),
    ...
    (e.width = e.width),
      ...
      b.txtOpt &&
        ...
        f < e.naturalWidth || d < e.naturalHeight
          ? ((c = U(g, f, d)), c && (a.fimage = c))
          : ((f = a.iw), (d = a.ih), (h = 1)),
        parseFloat(b.imageRadius) &&
          (a.image = a.fimage = g = an(a.image, b.imageRadius, f, d, h)),
        a.HasText() ||
          (b.shadow &&
            ((c = aJ(a.image, f, d, h, b.shadow, b.shadowBlur, b.shadowOffset)),
          ...
          b.outlineMethod == "size" &&
            (b.outlineIncrease > 0
              ? ((a.iw += 2 * b.outlineIncrease),
                ...
                (c = U(a.fimage, f, d)),
                (a.oimage = c),
                (a.fimage = O(a.fimage, a.oimage.width, a.oimage.height)))
              : ((f = h * (a.iw + 2 * b.outlineIncrease)),
                (d = h * (a.ih + 2 * b.outlineIncrease)),
                (c = U(a.fimage, f, d)),
                (a.oimage = O(c, a.fimage.width, a.fimage.height)))))),
      (a.alt = i),
      a.Init();
  }
  function j(a, d) {
  ...
  function ab(e) {
    ...
    f &&
      c.tc[f] &&
      ((b = c.tc[f]),
      (d = N(e, b.canvas)) && ((b.mx = d.x), (b.my = d.y), b.Drag(e, d)),
      (b.drawn = 0));
  }
  function aq(b) {
    var e = a,
  ...
  function ar(b) {
    ...
    e &&
      b.button == g &&
      f.tc[e] &&
      ((d = f.tc[e]), ab(b), !d.EndDrag() && !d.touchState && d.Clicked(b));
  }
  function at(c) {
    var e = A(c),
      b = e && a.tc[e],
    ...
    b &&
      ...
      (c.touches.length == 1 && b.touchState == 0
        ? ((b.touchState = 1),
          b.BeginDrag(c),
          (d = N(c, b.canvas)) && ((b.mx = d.x), (b.my = d.y), (b.drawn = 0)))
  ...
  (g = $.prototype),
    ...
    (g.DrawColour = function (d, h, i, e, f, g, a, b, c) {
      return a.oimage
        ? (this.pulse < 1
    ...
    (g.DrawColourText = function (f, h, i, j, g, e, a, b, c) {
      var d = a.colour;
      return (a.colour = e), (a.alpha = 1), a.Draw(f, b, c), (a.colour = d), 1;
    }),
    (g.DrawColourImage = function (a, q, p, o, n, m, g, r, k) {
      var f = a.canvas,
        e = ~~h(q, 0),
        d = ~~h(p, 0),
        ...
        j;
      return (
        v ? ((v.width = c), (v.height = b)) : (v = l(c, b)),
        !v
          ? this.SetMethod("outline")
          : ((j = v.getContext("2d")),
            j.drawImage(f, e, d, c, b, 0, 0, c, b),
            a.clearRect(e, d, c, b),
            this.pulsate ? (g.alpha = 1 - x(this.pulse, 2)) : (g.alpha = 1),
            g.Draw(a, r, k),
            a.setTransform(1, 0, 0, 1, 0, 0),
            a.save(),
            a.beginPath(),
    ...
    (g.DrawPulsate = function (h, d, e, f) {
      var g = q() - this.ts,
        c = this.tc,
        b =
          c.pulsateTo +
          (1 - c.pulsateTo) *
            (0.5 + m((2 * Math.PI * g) / (1e3 * c.pulsateTime)) / 2);
      return (
        (this.pulse = b = a.Smooth(1, b)), this.DrawSimple(h, d, e, f, b, 1)
      );
    }),
    (g.Active = function (d, a, b) {
      var c =
        a >= this.x &&
        b >= this.y &&
        a <= this.x + this.w &&
    ...
    (g.PreDraw = g.PostDraw = g.LastDraw = y);
  function M(a, h, c, b, e, f, g, d, i, j, k, l, m, n) {
    (this.tc = a),
      ...
      (this.a = c),
      (this.position = new t(b[0], b[1], b[2])),
  ...
  (d = M.prototype),
        ...
        a.txtOpt &&
          ...
          a.outlineMethod == "colour"
            ...
            : a.outlineMethod == "size" &&
              ...
              a.outlineIncrease > 0
                ? (c = O(c, this.oimage.width, this.oimage.height))
                : (this.oimage = O(this.oimage, c.width, c.height))),
          c &&
            ((this.fimage = c),
    ...
    (d.Weight = function (b, i, a, d, f, g, e) {
      b = isNaN(b) ? 1 : b;
      var c = (b - f) / (g - f);
      "colour" == d
        ? (this.colour = H(a, c, e))
    ...
    (d.Calc = function (g, e) {
      ...
      return (
        ...
        (this.xformed = a),
        (a = aD(b, a, b.stretchX, b.stretchY)),
        (this.x = a.x),
        (this.y = a.y),
        (this.z = a.z),
        (this.sc = a.w),
        (this.alpha = e * I(d + ((f - d) * (c - this.z)) / (2 * c), 0, 1)),
        this.xformed
      );
    }),
    ...
    (d.PlayAudio = function () {
      ...
      if (a) {
        ...
        return (
          (c.gain.value = i(2, h(0, this.tc.audioVolume * 1))),
          (a.currentTime = 0),
          (this.stopped = 0),
          (b = a.play()),
          b !== void 0 &&
  ...
  function a(f, m, j) {
    ...
    if (
      ...
      for (d = 0; d < l.length; ++d) g[l[d]] = b[l[d]];
      throw (b.parentNode.insertBefore(g, b), b.parentNode.removeChild(b), 0);
    }
    for (d in a.options)
    ...
    if (
      ...
      (this.z1 = 250 / h(this.depth, 0.001)),
      ...
      (this.pulsateTo = I(this.pulsateTo, 0, 1)),
      (this.minBrightness = I(this.minBrightness, 0, 1)),
      (this.maxBrightness = I(this.maxBrightness, this.minBrightness, 1)),
      ...
      this.minTags > 0 &&
        ...
        (this.repeatTags = W(this.minTags / d) - 1),
      ...
      (k[f] = [
        ...
        this.dragControl &&
          (k[f].push(["mousedown", aq]), k[f].push(["selectstart", y])),
        this.wheelZoom &&
          (k[f].push(["mousewheel", V]), k[f].push(["DOMMouseScroll", V])),
        this.scrollPause && k[f].push(["scroll", ax, window]);
      for (d = 0; d < k[f].length; ++d)
        (g = k[f][d]), w(g[0], g[1], g[2] ? g[2] : b);
    }
    a.started ||
      ((a.NextFrame = window.requestAnimationFrame ? aA : aB),
  ...
  (b = a.prototype),
    ...
    (b.CreateTag = function (b) {
      ...
      if (
        ...
        return (
          ...
          c ? (a.SetImage(c), E(c, e[0], e[1], a, this)) : a.Init(),
          this.AddAudio(b, a),
          a
        );
    }),
    ...
    (b.Load = function () {
      ...
      if (c.length) {
        ...
        this.shuffleTags && ah(e),
          (g = 100 * this.radiusX),
          (i = 100 * this.radiusY),
          (j = 100 * this.radiusZ),
          (this.max_radius = h(g, h(i, j)));
        ...
        this.weight && this.Weight(b, !0),
          this.shapeArgs
            ...
            : ((l = this.shape.toString().split(/[(),]/)),
              ...
              (this.shapeArgs = [b.length, g, i, j].concat(l))),
          (f = this.shape.apply(this, this.shapeArgs)),
          (this.listLength = b.length);
        for (a = 0; a < b.length; ++a)
          b[a].position = new t(f[a][0], f[a][1], f[a][2]);
      }
      this.noTagsMessage &&
        !b.length &&
        ((a =
    ...
    (b.Update = function () {
      ...
      if (e.length) {
        ...
        for (b = d.length / (f.length + 1), a = 0; f.length; )
          d.splice(W(++a * b), 0, this.CreateTag(e[f.shift()]));
        (this.shapeArgs[0] = g = d.length),
          (h = this.shape.apply(this, this.shapeArgs));
        for (a = 0; a < g; ++a)
          d[a].position = new t(h[a][0], h[a][1], h[a][2]);
    ...
    (b.LoadAudio = function () {
      ...
      (this.audio = c.createElement("audio")),
        ...
        (this.hasAudio = 1),
        (T = function (a) {
          e.resume(), c.removeEventListener("click", T);
        }),
    ...
    (b.ShowAudioIcon = function () {
      ...
      b || (b = e.state === l),
        this.audioIcon &&
          this.hasAudio &&
          (ae(b, d, a, k, f, g + 1, j ? i : h),
          ae(b, d, a, k, f, g, j ? h : i));
    }),
  ...
  (b.BeginPinch = function (a) {
    (this.pinched = [ag(a), this.zoom]), a.preventDefault && a.preventDefault();
  }),
    (b.Pinch = function (d) {
      var b,
        c,
      ...
      (c = ag(d)),
        (b = (a[1] * c) / a[0]),
        (this.zoom = i(this.zoomMax, h(this.zoomMin, b))),
        this.Zoom(this.zoom);
    }),
